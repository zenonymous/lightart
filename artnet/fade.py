...
async def functie():
    ...
    channel4.add_fade([ja,bla,ha,bla,ja,ha], timer4)
    channel5.add_fade([bla,ha,ja,bla,ha,ja], timer3)
    channel6.add_fade([ja,ha,bla,ja,ha,bla], timer2)
    channel7.add_fade([bla,bla,ja,ja,ha,ha], timer1)
